...
def manager(context):
    ...
    user.user_permissions.add(Permission.objects.get(codename='manage_producers'))
    user.set_password(password)
    user.save()
    context.manager = {
        'email': user.email,
...
def rex(context):
    ...
    user.user_permissions.add(Permission.objects.get(codename='manage_producers'))
    user.user_permissions.add(Permission.objects.get(codename='manage_managers'))
    user.user_permissions.add(Permission.objects.get(codename='manage_users'))
