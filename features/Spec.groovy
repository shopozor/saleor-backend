  ...
  stages {
    stage('Spec generation') {
      ...
      steps {
        ...
        sh "sshpass -p $SOFTOZOR_CREDENTIALS_PSW scp -o StrictHostKeyChecking=no -r specification $SOFTOZOR_CREDENTIALS_USR@softozor.ch:~/www/www.softozor.ch/shopozor/backnd/"
      }
    }
  }
}